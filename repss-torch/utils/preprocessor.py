...
def preprocessing(save_root_path: str = "D:/preprocessed_dataset/",
                  dataset_root_path: str = "D:/VIPL_HR/data",
    ...
    for index, data_path in enumerate(return_dict.keys()[train:]):
        if index % 3 == 0:
            test_file = h5py.File(save_root_path + "test_" + str(index_name) + '.hdf5', "w")
            index_name += 1
...
if __name__ == '__main__':
    preprocessing(save_root_path="D:/preprocessed_dataset/",
                  dataset_root_path="D:/VIPL_HR/data",
                  train_ratio=0.8)